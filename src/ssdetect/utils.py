...
IMAGE_EXTENSIONS = {".jpg", ".jpeg", ".png", ".bmp", ".gif", ".webp", ".tiff", ".tif", ".heic", ".heif", ".avif"}


def setup_logging(json_output: bool = False, script_mode: bool = False) -> structlog.BoundLogger:
